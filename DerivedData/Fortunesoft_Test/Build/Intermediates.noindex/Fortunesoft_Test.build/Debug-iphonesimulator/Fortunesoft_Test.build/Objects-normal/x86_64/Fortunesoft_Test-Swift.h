...
#ifndef FORTUNESOFT_TEST_SWIFT_H
#define FORTUNESOFT_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Fortunesoft_Test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Fortunesoft_Test11AppDelegate")
...
SWIFT_CLASS("_TtC16Fortunesoft_Test18CollectionViewCell")
...
SWIFT_CLASS("_TtC16Fortunesoft_Test13SceneDelegate")
...
SWIFT_CLASS("_TtC16Fortunesoft_Test18TestViewController")
...
@interface TestViewController (SWIFT_EXTENSION(Fortunesoft_Test)) <UICollectionViewDataSource, UICollectionViewDelegate>
